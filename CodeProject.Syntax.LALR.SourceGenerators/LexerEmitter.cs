...
internal static class LexerEmitter
{
    ...
    private const string ColumnModeFqn = "global::CodeProject.Syntax.LALR.LexicalGrammar.ColumnMode";
    ...
    public static EmitResult Emit(GrammarSchema schema, string namespaceName, string className)
    {
        ...
        var columnMode = schema.Columns ?? CodeProject.Syntax.LALR.LexicalGrammar.ColumnMode.Codepoints;
    ...
    private static string Render(List<(string Name, string[] Rules)> states, string namespaceName, string className,
        CodeProject.Syntax.LALR.LexicalGrammar.ColumnMode columnMode)
    {
